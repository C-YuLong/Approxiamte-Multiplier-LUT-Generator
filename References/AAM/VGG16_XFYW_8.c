...
inline uint64_t VGG16_XFYW_8(uint64_t x, uint64_t y) {
    ...
    new_part1 |= ((0) ? 1U : 0U) << 6;
    new_part1 |= ((((part3 >> 3) && 1)||((part4 >> 2) && 1)) ? 1U : 0U) << 5;
    new_part1 |= ((0) ? 1U : 0U) << 4;
    new_part1 |= ((((part1 >> 3) && 1)||((part2 >> 2) && 1)) ? 1U : 0U) << 3;
    ...
    new_part2 |= ((0) ? 1U : 0U) << 5;
    new_part2 |= ((0) ? 1U : 0U) << 4;
    new_part2 |= ((((part3 >> 1) && 1)^((part4 >> 0) && 1)) ? 1U : 0U) << 3;
    new_part2 |= ((0) ? 1U : 0U) << 2;
    new_part2 |= ((0) ? 1U : 0U) << 1;
    new_part2 |= ((0) ? 1U : 0U) << 0;
